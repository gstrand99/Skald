...
pub const SERVICE_UNIT_NAME: &str = "voxlined.service";
...
mod tests {
    ...
    fn renders_expected_systemd_unit() {
        let unit = render_service_unit("/home/user/.local/bin/voxlined", "info");
        assert!(unit.contains("ExecStart=/home/user/.local/bin/voxlined"));
